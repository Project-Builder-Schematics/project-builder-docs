...
escape hatch (see [the Modify guide](/guides/modify/)). This is
...
into an AST. That understanding lives in the [dialects](/guides/modify/):
...
See [Modify](/guides/modify/) for the full authoring
surface.
